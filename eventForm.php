...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
    ...
    ?>  
        ...
        <?php
        if ($_SESSION['access_level']==2) {
            echo('<p>&nbsp;&nbsp;&nbsp;&nbspStart Time <span style="font-size:x-small;color:FF0000">*</span>:<input type="text" name="start_time" tabindex="2"<br>');
            echo('&nbsp;&nbsp;&nbsp;&nbspEnd Time <span style="font-size:x-small;color:FF0000">*</span>:<input type="text" name="end_time" tabindex="2"<br>');
